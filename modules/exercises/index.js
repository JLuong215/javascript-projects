...
const print = require('./display.js')//Import function from display.js.
...
for (let i = 0; i<prompts.length; i++){
  ...
  if (response.toLowerCase()==='y'){
    if (i===0){
      print.printAll(astronauts, testTitles, scores);//Call 'printAll' here and pass in all necessary arguments.
    } else if (i===1){
